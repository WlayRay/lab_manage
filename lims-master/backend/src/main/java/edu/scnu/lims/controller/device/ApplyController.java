...
public class ApplyController {
    ...
    public CommonResult<List<DeviceApply>> getApplyList(@RequestHeader(value = "Authentication-Token") String token,
        ...
        if (UserRoleEnum.SUPER_ADMIN == user.getRole()) {
             ...
             * return CommonResult.success(deviceApplyService.
             * getDeviceAppliesByUserIdOrLaboratoryId(page, pageSize,
             * user.getUserId(), laboratory2.getLaboratoryId()));
             * } else {
             * deviceApply.setUser(user);
             * return CommonResult.success(deviceApplyService.getDeviceApplies(page,
             * pageSize, deviceApply));
             * }
             */
        }
    }
    ...
    public CommonResult<Long> countApplyList(@RequestHeader(value = "Authentication-Token") String token,
        ...
        if (UserRoleEnum.SUPER_ADMIN == user.getRole()) {
            ...
            if (laboratory2 != null) {
                return CommonResult
                        .success(deviceApplyService.countDeviceAppliesByUserIdOrLaboratoryId(user.getUserId(),
